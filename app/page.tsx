...
export default function Home() {
    ...
    return (
        <div className="relative min-h-dvh overflow-clip bg-white text-zinc-900 dark:bg-black dark:text-zinc-100">
            ...
            {/* Nav */}
            <header className="mx-auto max-w-6xl px-6 py-6 flex flex-wrap items-center justify-between gap-3 md:grid md:grid-cols-3">
                ...
                <nav
                    className="hidden md:flex items-center justify-center gap-4 text-sm md:col-start-2 md:col-end-3"
                    aria-label="Primary"
                >
                ...
                <div className="flex items-center gap-2 ml-auto md:ml-0 md:justify-self-end">
                    <a
                        href={WHATSAPP_URL || '#'}
                        aria-disabled={!WHATSAPP_URL}
                        className={`hidden sm:inline-flex rounded-full px-4 py-2 text-center text-sm font-medium text-white shadow-sm transition active:scale-[.99] ${
                            WHATSAPP_URL
                    ...
                    {/* Mobile dropdown with links + theme */}
                    <MobileDropdown whatsappUrl={WHATSAPP_URL} />
                </div>
            </header>
            ...
            >
                    ...
                    <div className="grid items-center gap-10 lg:grid-cols-2">
                        <div className="max-w-2xl">
                            ...
                            <h1 className="text-balance text-4xl font-black tracking-tight sm:text-5xl md:text-6xl">
                                Build consistency. Find your tribe. Ship your
                                dreams.
                            </h1>
                            <p className="mt-5 max-w-2xl text-pretty text-lg leading-relaxed text-zinc-700 dark:text-zinc-300">
                                We are a small community of aspiring competitive
                                programmers pushing each other to stay
                                consistent and improve every day. The goal is
                                simple: share your progress, create healthy
                                FOMO, motivate and help everyone level up
                                together.
                            </p>
                            ...
                            {!WHATSAPP_URL && (
                                <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400">
                                    We will add the group link soon. You can
                                    still explore what GrindHub is about below.
                                </p>
                            )}
                        </div>
                        {/* Right column: QR card (center on small, right on large) */}
                        <div className="w-full max-w-full mx-auto lg:ml-auto lg:w-auto">
                            <div className="grid place-items-center rounded-2xl border border-zinc-200/70 bg-white/70 p-5 backdrop-blur dark:border-white/10 dark:bg-white/5">
                                <img
                                    ...
                                    className="w-56 max-w-full h-auto rounded-md border border-zinc-200/60 object-contain dark:border-white/10 sm:w-64"
                                    loading="lazy"
                                />
                            </div>
                        </div>
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-zinc-200/70 bg-white/70 backdrop-blur dark:border-white/10 dark:bg-white/5">
                        ...
                        <div className="px-6 py-5">
                            <p className="text-zinc-700 dark:text-zinc-300">
                                Use this concise template. It helps others learn
                                patterns and reinforces your understanding
                                through recall.
                            </p>
                                ...
                                <div className="rounded-[11px] bg-zinc-50 p-4 dark:bg-zinc-950">
                                    <div className="grid gap-2 font-mono text-sm leading-relaxed">
                                        ...
                                        <div>
                                            ...
                                            <span className="ml-1 text-zinc-700 dark:text-zinc-300">
                                                [Main idea or insight in one or
                                                two lines]
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <p className="mt-3 text-zinc-700 dark:text-zinc-300">
                                Stay accountable. Keep your progress consistent.
                                Let’s grind smarter 💪
                            </p>
                        </div>
                    </div>
                ...
                <section id="why" className="mt-24">
                    ...
                    <p className="mt-3 max-w-2xl text-zinc-700 dark:text-zinc-300">
                        Supportive, competition‑friendly, and judgment‑free.
                        Show up consistently, learn faster, and keep your
                        momentum with a little healthy FOMO. I started GrindHub
                        to give working professionals and tier‑2/3 students the
                        focused environment many don&apos;t have.
                    </p>
                ...
                <section id="how" className="mt-24">
                    ...
                    <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {[
                            ...
                            {
                                n: '04',
                                t: 'Learn patterns and stay consistent',
                            },
                        ].map((s) => (
                            <div
                                key={s.n}
                ...
                <section className="mt-24" aria-labelledby="commitment-policy">
                    ...
                    <p className="mt-3 max-w-2xl text-zinc-700 dark:text-zinc-300">
                        Inconsistency gets you kicked out. If you go inactive,
                        you’ll be removed. You can reapply, but acceptance won’t
                        be easy.
                    </p>
                </section>
                    ...
                    <div className="mt-6 grid gap-6 sm:grid-cols-2">
                        <div className="rounded-xl border border-zinc-200/70 bg-white/70 p-6 backdrop-blur dark:border-white/10 dark:bg-white/5">
                            ...
                            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
                                Yes, this is a beginner‑friendly group. The only
                                rule is: show up daily.
                            </p>
                        </div>
                        <div className="rounded-xl border border-zinc-200/70 bg-white/70 p-6 backdrop-blur dark:border-white/10 dark:bg-white/5">
                            <h4 className="font-semibold">
                            ...
                            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
                                All updates are in the WhatsApp group. Check
                                pinned messages for announcements and weekly
                                challenges.
                            </p>
                        </div>
                        <div className="rounded-xl border border-zinc-200/70 bg-white/70 p-6 backdrop-blur dark:border-white/10 dark:bg-white/5">
                            <h4 className="font-semibold">
                                What tracks can I pick?
                            </h4>
                            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
                                DSA/CP are most active, any deep‑work focus is
                                welcome, though FOMO hits hardest there.
                            </p>
                        </div>
                        <div className="rounded-xl border border-zinc-200/70 bg-white/70 p-6 backdrop-blur dark:border-white/10 dark:bg-white/5">
